...
if __name__ == '__main__':
    ...
    # pos = [30, 60, -200, 30, -60, -200, 30, -60, -200, 30, 60, -200, [0,0,0,0,0,0],[0,0,10,10,-10,-10,0,0,0], [0,0,10,10,-10,-10,0,0,0], [0,200,0,0,0,0,0,0,0]]
    print(pos)
    b_height = 200 # 身體高度
    pos_init = [-x_offset,track,-b_height,-x_offset,-track,-b_height,-x_offset,-track,-b_height,-x_offset,track,-b_height]
    # pos_init = [30, 60, -200, 30, -60, -200, 30, -60, -200, 30, 60, -200]
    # print(pos_init)
